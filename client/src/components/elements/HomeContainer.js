...
// Import components
import SteamIdSearchBar from './universal/SteamIdSearchBar.js'

const HomeContainer = () =>{
    return(
        <div className='box' box-radius='large'>
            <h1 className='title is-1'>Arch - Steam Achievement Viewer</h1>
            ...
            <div className='card'>
                ...
                <div className='card-content is-overlay mt-large' id='searchBoxOverlay'>
                    ...
                    <div className='tile is-parent'>
                        ...
                        <div className='tile is-child is-5'>
                            ...
                            <div className='buttons'>
                                ...
                                <a className='button is-dark' href='https://github.com/viljaa/SteamAchievementViewer'>Project</a>
                            </div>
                        </div>
                    </div>
                </div>
